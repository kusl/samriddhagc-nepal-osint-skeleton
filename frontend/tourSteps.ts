...
const DESKTOP_STEPS: DashboardTourStep[] = [
  ...
  },
  {
    ...
    description: 'Provincial Monitor is now the fastest structured read after the map. Use it to see where pressure, risk, or stability is concentrating across all seven provinces.',
...
const MOBILE_STEPS: DashboardTourStep[] = [
  ...
  {
    id: 'provincial-monitor',
    title: 'Start with the province board',
    description: 'Provincial Monitor gives you the fastest structured read across Nepal after the map, so you can spot where pressure is building before opening individual feeds.',
    targetId: 'provincial-monitor',
    placement: 'bottom',
    mobileEnabled: true,
    requiresScroll: true,
