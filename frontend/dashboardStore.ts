...
export const PRESETS: Record<string, Preset> = {
  ...
  news: {
    ...
    order: [
      'map', 'kpi', 'province-monitor', 'newsfeed', 'developing-stories',
      'fact-check', 'stories', 'social', 'narrative-tracker', 'market',
    ...
    sizes: {
      ...
      market: 'medium',               // Row 7: 6 cols
      weather: 'medium',              // Row 7: 6 cols (6+6=12)
      'source-reliability': 'medium', // Row 8: 6 cols
      disasters: 'medium',            // Row 8: 6 cols (6+6=12)
      govt: 'full',                   // Row 9: 12 cols
    }
  },
  ...
  analyst: {
    ...
    description: 'Election coverage with provincial monitoring, live feeds & social signals',
    order: [
      'election-map', 'kpi', 'province-monitor', 'newsfeed', 'developing-stories',
      'stories', 'social', 'election-status', 'fact-check'
    ],
    visibility: {
      'election-map': true, kpi: true, 'province-monitor': true, newsfeed: true,
    ...
    sizes: {
      ...
      kpi: 'full',
      'province-monitor': 'full',
      newsfeed: 'medium',
      'developing-stories': 'medium',
      stories: 'medium',
      social: 'medium',
  ...
  intelligence: {
    ...
    order: [
      'map', 'kpi', 'province-monitor', 'developing-stories', 'fact-check',
    ...
    sizes: {
      ...
      'province-monitor': 'full',     // Row 3: 12 cols
...
export const useDashboardStore = create<DashboardState>()(
  persist(
    ...
    {
      name: 'rta-dashboard-v14',  // v60: retire national assessment surfaces and promote province monitor
      version: 60,
