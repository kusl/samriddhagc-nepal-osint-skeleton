...
const IMMEDIATE_WIDGETS_BY_PRESET: Record<string, string[]> = {
  news: ['kpi', 'province-monitor', 'developing-stories', 'newsfeed'],
  ...
  intelligence: ['kpi', 'province-monitor', 'developing-stories', 'fact-check'],
};

const MOBILE_WIDGETS_BY_PRESET: Record<string, string[]> = {
  news: ['province-monitor', 'developing-stories', 'fact-check', 'newsfeed', 'market'],
  analyst: ['election-map', 'province-monitor', 'newsfeed', 'election-status', 'fact-check'],
  intelligence: ['map', 'province-monitor', 'developing-stories', 'fact-check', 'newsfeed'],
