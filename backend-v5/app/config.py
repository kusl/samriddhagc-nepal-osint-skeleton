...
EmbeddingModelKey = Literal["e5-large", "e5-base", "minilm", "openai-3-small", "openai-3-large"]
...
class Settings(BaseSettings):
    ...
    openai_briefing_enabled: bool = False
    openai_briefing_model: str = "gpt-4.1-mini"
    openai_briefing_hours: int = 12
    openai_briefing_prompt_chars: int = 90000
    openai_briefing_completion_tokens: int = 1600
    ...
    consumer_notifications_enabled: bool = True
