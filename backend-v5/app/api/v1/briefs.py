"""API endpoints for situation briefs (Narada Analyst Agent output)."""
...
async def ingest_brief(
    ...
    try:
        ...
        try:
            await NotificationMatchingService(db).process_brief(brief)
        except Exception as e:
            logger.warning("Brief notification generation failed: %s", e)
