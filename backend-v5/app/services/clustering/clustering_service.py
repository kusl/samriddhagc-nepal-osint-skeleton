...
class ClusteringService:
    ...
    async def _create_or_update_cluster_with_corroboration(
        ...
        if existing_cluster:
            ...
            existing_cluster.headline = payload["headline"]
            existing_cluster.summary = payload["summary"]
            existing_cluster.category = payload["category"]
            existing_cluster.severity = payload["severity"]
            existing_cluster.event_type = payload["event_type"]
            existing_cluster.primary_province = payload["primary_province"]
            existing_cluster.primary_district = payload["primary_district"]
            existing_cluster.primary_municipality = payload["primary_municipality"]
            existing_cluster.geo_confidence = payload["geo_confidence"]
            existing_cluster.main_entities = payload["main_entities"]
            existing_cluster.novelty_score = payload["novelty_score"]
            existing_cluster.heat_score = payload["heat_score"]
            existing_cluster.spread_score = payload["spread_score"]
            existing_cluster.event_confidence = payload["event_confidence"]
            existing_cluster.actionability = payload["actionability"]
            existing_cluster.intelligence_score = payload["intelligence_score"]
            existing_cluster.story_count = payload["story_count"]
            existing_cluster.source_count = payload["source_count"]
            existing_cluster.unique_sources = payload["unique_sources"]
            existing_cluster.diversity_score = payload["diversity_score"]
            existing_cluster.confirmation_chain = payload["confirmation_chain"]
            existing_cluster.confidence_level = payload["confidence_level"]
            existing_cluster.languages = payload["languages"]
            existing_cluster.cross_lingual_match = payload["cross_lingual_match"]
            existing_cluster.social_post_count = payload["social_post_count"]
            existing_cluster.official_confirmation_count = payload["official_confirmation_count"]
            existing_cluster.first_published = payload["first_published"]
            existing_cluster.last_updated = payload["last_updated"]
            ...
            cluster = StoryCluster(
                ...
                primary_province=payload["primary_province"],
                primary_district=payload["primary_district"],
                primary_municipality=payload["primary_municipality"],
                ...
                spread_score=payload["spread_score"],
                event_confidence=payload["event_confidence"],
                actionability=payload["actionability"],
                intelligence_score=payload["intelligence_score"],
                story_count=payload["story_count"],
                source_count=payload["source_count"],
                unique_sources=payload["unique_sources"],
                diversity_score=payload["diversity_score"],
                confirmation_chain=payload["confirmation_chain"],
                confidence_level=payload["confidence_level"],
                languages=payload["languages"],
                cross_lingual_match=payload["cross_lingual_match"],
                social_post_count=payload["social_post_count"],
                official_confirmation_count=payload["official_confirmation_count"],
