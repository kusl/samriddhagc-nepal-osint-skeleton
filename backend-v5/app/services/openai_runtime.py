...
class OpenAIRuntime:
    ...
    async def json_completion(
        ...
        *,
        ...
        prompt_char_limit: Optional[int] = None,
        respect_structured_completion_cap: bool = True,
        ...
        prompt_char_limit = max(
            1,
            prompt_char_limit or self.settings.openai_max_structured_prompt_chars,
        )
        capped_tokens = max(1, max_completion_tokens)
        if respect_structured_completion_cap:
            capped_tokens = min(
                capped_tokens,
