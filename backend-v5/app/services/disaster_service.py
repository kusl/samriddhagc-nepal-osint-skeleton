...
class DisasterIngestionService:
    ...
    async def _process_incident(
        ...
        incident = DisasterIncident(
            ...
            estimated_loss=fetched.estimated_loss,
            # BIPAD's loss record id — LossSyncService needs it to fetch the
            # casualty/damage figures, which the incident payload never carries.
            bipad_loss_id=fetched.bipad_loss_id,
            people_affected=fetched.people_affected,
            families_relocated=fetched.families_relocated,
            families_evacuated=fetched.families_evacuated,
            houses_destroyed=fetched.houses_destroyed,
            houses_affected=fetched.houses_affected,
            roads_destroyed=fetched.roads_destroyed,
            bridges_destroyed=fetched.bridges_destroyed,
            livestock_destroyed=fetched.livestock_destroyed,
            infrastructure_loss_npr=fetched.infrastructure_loss_npr,
            agriculture_loss_npr=fetched.agriculture_loss_npr,
