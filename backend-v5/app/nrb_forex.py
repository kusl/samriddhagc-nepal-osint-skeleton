...
async def fetch_nrb_forex(currency: str = "USD") -> Optional[ForexRate]:
    ...
    try:
        async with httpx.AsyncClient(timeout=30.0) as client:
            ...
            # The NRB API returns payloads in ascending date order across the range.
            # Always prefer the latest available date, not the first row.
            latest_match: Optional[ForexRate] = None
