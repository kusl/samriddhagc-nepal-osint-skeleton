...
import {
  ...
  PriceWatchWidget,
  TradeCustomsWidget,
  PublicSpendingWidget,
  NrbMacroWidget,
  NrbPricesFlowsWidget,
  NrbBankingLiquidityWidget,
  FiscalPositionWidget,
  ExternalSectorWidget,
  MonetaryConditionsWidget,
  PricesCostPressureWidget,
...
export const WIDGET_COMPONENTS: Record<string, React.ComponentType> = {
  ...
  'debt-tracker': DebtTrackerWidget,
  'govt-contracts': GovtContractsWidget,
  'economic-news': EconomicNewsWidget,
  'price-watch': PriceWatchWidget,
  'trade-customs': TradeCustomsWidget,
  'public-spending': PublicSpendingWidget,
  'nrb-macro': NrbMacroWidget,
  'nrb-prices': NrbPricesFlowsWidget,
  'nrb-banking': NrbBankingLiquidityWidget,
  'fiscal-position': FiscalPositionWidget,
  'external-sector': ExternalSectorWidget,
  'monetary-conditions': MonetaryConditionsWidget,
  'prices-cost-pressure': PricesCostPressureWidget,
  rivers: RiverMonitoringWidget,
